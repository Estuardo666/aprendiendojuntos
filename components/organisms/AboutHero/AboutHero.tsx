        ...
        <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)] md:items-center md:gap-10">
          <div className="max-w-4xl text-center md:text-left">
            ...
            <Heading
              ...
              variant="display"
              animate={true}
              className="mx-auto mt-5 text-[clamp(2.7rem,6.2vw,5.8rem)] font-bold leading-[0.94] text-[#117fc3] md:mx-0"
            >
              {titulo}
            </Heading>
          </div>
          ...
          {descripcion && (
            <Text
              variant="body"
              className="mx-auto max-w-[48rem] text-[clamp(0.833rem,1.417vw,1.208rem)] leading-[1.22] text-[#253a44] text-center md:self-end md:justify-self-end md:text-justify"
            >
              {descripcion}
            </Text>
          )}
