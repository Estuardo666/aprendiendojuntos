...
description: >
  Convert UI screenshots into working HTML/CSS/React/Vue code. Detects design
  patterns, components, and generates responsive layouts. Use this when users
  provide screenshots of websites, apps, or UI designs and want code implementation.
---
...
> **Project note**: This project uses Next.js 14 App Router + TypeScript + Tailwind CSS with custom design tokens. When generating code for this project, always use the project's tokens (brand-naranja, brand-azul, brand-celeste, brand-crema, brand-blanco), font classes (font-heading, font-body), and follow Atomic Design rules from CLAUDE.md.
...
| Concern | Practice |
|---|---|
| Accuracy | Match design as closely as possible |
...
| Maintainability | Clean, organized code with comments |
| Responsiveness | Mobile-first when possible |
...
> The goal is to produce code so clean and accurate that it could be deployed immediately with minimal modifications.
